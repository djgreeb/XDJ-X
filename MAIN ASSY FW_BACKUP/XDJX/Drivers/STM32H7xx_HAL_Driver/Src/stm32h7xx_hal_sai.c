...
static void SFillFifo(SAI_HandleTypeDef *hsai);
...
void SAI_Transmit(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size)
	{
	if (hsai->State == HAL_SAI_STATE_READY)
		{
		// __HAL_LOCK(hsai);
...
void SAI_IRQHndlr(SAI_HandleTypeDef *hsai)
	{
