...
//
//
HAL_StatusTypeDef HAL_DMA_GO(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t DataLength)
{
  HAL_StatusTypeDef status = HAL_OK;
	__HAL_DMA_DISABLE(hdma);
	DMA_SetConfig(hdma, SrcAddress, DstAddress, DataLength);
...
//
//
HAL_StatusTypeDef HAL_DMA_Poll(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t cpltlevel_mask;
